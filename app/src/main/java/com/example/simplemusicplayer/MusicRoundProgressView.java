...
public class MusicRoundProgressView  extends View {
    ...
    public MusicRoundProgressView(Context context) {
        super(context);
    }
    ...
    public MusicRoundProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
